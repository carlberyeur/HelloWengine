...
namespace cu
{
	...
	public:
		...
		HW_INLINE Vector3& operator=(const Vector3& aRight);
		template <typename U> Vector3& operator=(const Vector3<U>& aRight);
		HW_INLINE Vector3& operator=(const Vector4<TYPE>& aRight);
		...
		HW_INLINE Vector3& operator*=(const TYPE aRight);
		HW_INLINE Vector3& operator/=(const TYPE aRight);

		HW_INLINE Vector3 operator+(const Vector3& aRight) const;
		HW_INLINE Vector3 operator-(const Vector3& aRight) const;
		HW_INLINE Vector3 operator*(const Vector3& aRight) const;
		HW_INLINE Vector3 operator/(const Vector3& aRight) const;

		HW_INLINE Vector3 operator*(const TYPE aScalar) const;
		HW_INLINE Vector3 operator/(const TYPE aRight) const;

		HW_INLINE Vector3 operator-() const;

		HW_INLINE bool operator==(const Vector3& aRight) const;
		HW_INLINE bool operator!=(const Vector3& aRight) const;

		TYPE Length() const;
		TYPE Length2() const;
		HW_INLINE TYPE Dot(const Vector3& aRight) const;
...
#pragma warning(default : 4201)
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE>& operator*=(const TYPE aLeft, Vector3<TYPE>& aRight)
	{
		return aRight *= aLeft;
	}
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE>& Vector3<TYPE>::operator=(const Vector3& aRight)
	{
		x = aRight.x;
		y = aRight.y;
		z = aRight.z;
	...
	template<typename TYPE>
	template<typename U>
	HW_INLINE Vector3<TYPE>& Vector3<TYPE>::operator=(const Vector3<U>& aRight)
	{
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE>& Vector3<TYPE>::operator=(const Vector4<TYPE>& aRight)
	{
		x = aRight.x;
		y = aRight.y;
		z = aRight.z;
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE>& Vector3<TYPE>::operator*=(const TYPE aRight)
	{
		x *= aRight;
		y *= aRight;
		z *= aRight;
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE> Vector3<TYPE>::operator+(const Vector3& aRight) const
	{
		Vector3 sum = self;
		return sum += aRight;
	}
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE> Vector3<TYPE>::operator*(const TYPE aScalar) const
	{
		Vector3 product = self;
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE> Vector3<TYPE>::operator/(const TYPE aRight) const
	{
		Vector3 quotient = self;
		return quotient /= aRight;
	}
	...
	template<typename TYPE>
	HW_INLINE Vector3<TYPE> Vector3<TYPE>::operator-() const
	{
		return Vector3(-x, -y, -z);
	}

	template<typename TYPE>
	HW_INLINE bool Vector3<TYPE>::operator==(const Vector3& aRight) const
	{
	...
	template<typename TYPE>
	HW_INLINE TYPE Vector3<TYPE>::Dot(const Vector3& aRight) const
	{
		return ((x * aRight.x) + (y * aRight.y) + (z * aRight.z));
	}
